...
def main():
    ...
    testImagePath = './images_split/val/'
...
def lbp(images):
    ...
    for image in images:
        ...
        lbpimage = feature.local_binary_pattern(image, 8, 1, method='default') ##
        cvimg = np.float32(lbpimage) ##
        hist = cv2.calcHist([cvimg], [0], None, bins, [0, 256]) ##
